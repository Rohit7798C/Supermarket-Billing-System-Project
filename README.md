...
We can also add UI to this project by using MFC. We need to use Visual Studio to built the UI using the MFC.
You have to learn about the Tools in the Visual Studio.
